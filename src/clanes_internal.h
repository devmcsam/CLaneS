...
#define CLANES_CPUID_7_0_EBX_AVX512F   16u
#define CLANES_CPUID_7_0_EBX_AVX512DQ  17u
#define CLANES_CPUID_7_0_EBX_AVX512BW  30u
#define CLANES_CPUID_7_0_EBX_AVX512VL  31u

// ============================================================
//  CPU feature bits — packed into a single uint32_t
// ============================================================
...
#define CLANES_CPU_AVX512F   (1u <<  9)
#define CLANES_CPU_AVX512BW  (1u << 10)
#define CLANES_CPU_AVX512VL  (1u << 11)
#define CLANES_CPU_AVX512DQ  (1u << 12)
...
typedef struct {
    ...
    ClanesSimdLevel max_level; // resolved widest tier
} ClanesCPUInfo; // 8 bytes total

// Immutable after clanes_init(). Safe to read from any thread.
extern ClanesCPUInfo g_clanes_cpu;
