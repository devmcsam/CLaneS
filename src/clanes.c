...
void clanes_init(void) {
    ...
    if(__get_cpuid_count(7, 0, &eax, &ebx, &ecx, &edx)) {
        ...
        if(ebx & (1U << CLANES_CPUID_7_0_EBX_AVX512F)) {
            f |= CLANES_CPU_AVX512F;
        }
        if(ebx & (1U << CLANES_CPUID_7_0_EBX_AVX512DQ)) {
            f |= CLANES_CPU_AVX512DQ;
        }
        if(ebx & (1U << CLANES_CPUID_7_0_EBX_AVX512BW)) {
            f |= CLANES_CPU_AVX512BW;
        }
        if(ebx & (1U << CLANES_CPUID_7_0_EBX_AVX512VL)) {
            f |= CLANES_CPU_AVX512VL;
        }
    }
